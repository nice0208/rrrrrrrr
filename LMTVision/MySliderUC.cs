...
namespace Inkiness_Machine
{
    ...
    public partial class MySliderUC : UserControl
    {
        ...
        public delegate void ValueChangeEventHandler(int CurrentValue);
        public event ValueChangeEventHandler ValueChanged;
        public void ValueChangedEvent(int CurrentValue)
        {
